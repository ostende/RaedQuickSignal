                ...
                if self.type == self.emuname:
                        ...
                        # Merlin2       
                                ...
                                try:
                                        ...
                                        camdlist = None
                        # GP3
                        elif os.path.exists(resolveFilename(SCOPE_LIBDIR, "enigma2/python/Plugins/Bp/geminimain/lib/libgeminimain.so")):
                                try:
                                        ...
                                        camdlist = None
                        # GP4
                        elif os.path.exists(resolveFilename(SCOPE_LIBDIR, "enigma2/python/Plugins/GP4/geminicamswitch/gscamtools.so")):
